...
{
    /// <inheritdoc />
    public partial class _28Maj : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rafts_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Rafts_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SalesOrders_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackingLists_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PackingLists_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PackingLists_SalesOrders_SalesOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pallets_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Pallets_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_ProductId_RaftId",
                table: "Inventories",
                columns: new[] { "ProductId", "RaftId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackingLists_SalesOrderId",
                table: "PackingLists",
                column: "SalesOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_PackingLists_UpdatedById",
                table: "PackingLists",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rafts_CreatedById",
                table: "Rafts",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Rafts_UpdatedById",
                table: "Rafts",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_UpdatedById",
                table: "SalesOrders",
                column: "UpdatedById");
